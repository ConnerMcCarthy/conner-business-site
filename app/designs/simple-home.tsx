          ...
          <div className="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3">
            {[
              ...
              },
              {
                ...
                href: "/intake",
                internal: true,
                description: "Define projects in minutes. Visitors answer a few questions one at a time. You get a clear summary and requirements. No long email chains.",
                icon: "intake",
              },
              {
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            ...
            <div className="rounded-3xl border border-slate-200 bg-slate-50 p-6 transition-all duration-200 hover:scale-105 hover:shadow-lg hover:-translate-y-1 hover:border-slate-300 min-h-[120px]">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-semibold">Starting at $35 / month</span>
              </div>
